...
export class I18nPageComponent {
  source = {
    html: require('!!raw-loader!./../../panels/i18n-company-panel/i18n-company-panel.component.html')
      .default,
    ts: require('!!raw-loader!./../../panels/i18n-company-panel/i18n-company-panel.component.ts')
      .default,
  };
