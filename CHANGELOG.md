...
* Add method resetValidateAllFormFields to reset all errors ([8642886](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/8642886a966998e8a42c49c59666b79718fdf377))
* Add objectChange event on update with set object ([62e05d8](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/62e05d82d7a7075b5c5313c3cf00eedcb249c829))
...
* Add support bind class validator to array controls and array form groups ([#74](https://github.com/EndyKaufman/ngx-dynamic-form-builder/issues/74), [#75](https://github.com/EndyKaufman/ngx-dynamic-form-builder/issues/75)) ([90f8c3e](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/90f8c3ef6f5d2280fc9fecba2480429baa46a159))
* Add support classLevelValidator with native angular validators and update sample for it ([#106](https://github.com/EndyKaufman/ngx-dynamic-form-builder/issues/106), [#107](https://github.com/EndyKaufman/ngx-dynamic-form-builder/issues/107)) ([26ee044](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/26ee0449543495effc75df9d61e1a6d68665fae9))
...
* Add support use native angular validations, create sample for it - combo ([fd48f90](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/fd48f904c4ef2a6a4fd98a9035768fa43b175b52))
...
* Change externalErrors and validatorOptions with getter and setter to functions: setExternalErrorsAsync, setExternalErrors, clearExternalErrorsAsync, clearExternalErrors and setValidatorOptionsAsync, setValidatorOptions ([e256c0f](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/e256c0f97d6b55b4c5f7e96b115eea82f835a76f))
* **deps:** Update dependencies ([65913d1](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/65913d18ba6412a1c3d7225b08ac866904b919e0))
* **dynamic-form-builder:** Add support use ValidatorOptions ([57ac15a](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/57ac15a9fa74ee91dbe7612fb0d31db726d5bfbc))
* **dynamic-form-control:** Add validation definitions to form controls ([8cbb9a2](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/8cbb9a26a296f7a8b785aafcd8e1d897b7fcd9cc))
* **dynamic-form-group:** Added method classToClass and plainToClass to override and customize transformation algorithm ([734f9ea](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/734f9ea6d5dbe004fca6e47d3ce000d233068b24))
* **dynamic-form-group:** controlsConfig set to optional in method "group" ([811b824](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/811b82456f3afe11bc890382fdc308e192d35e17))
* **dynamic-form-group:** Group type safety ([f183e49](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/f183e493d5eda5bb23f6328428d984772a1df09b))
* **dynamic-form-group:** Implement a non-observable error API ([ac713c8](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/ac713c8584647328c0e302e104f7fee1d8f33067))
...
* Update to Angular 6 and Rx 6 ([f600e3c](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/f600e3c9c3540358a19d41dcf98fd82f1c5041e6))
...
* Add needed deps to devDependencies ([540e775](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/540e775bb40385888064f0cd2857d5e02d0e4107))
...
* Add use standalone lodash.clonedeep and lodash.mergewith in lib ([d38198d](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/d38198daad492d53d44ab7e154e228bdc4cdae1e))
* add usnscribe from subscribe to form group changes, change transform class validator to usage async angular validator ([59270ba](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/59270ba8b50a80cea7a9aa48d213ee94ee6a2549))
* Add whitelistedNonPeerDependencies in ng-package.json ([06fdac7](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/06fdac76fd38d538ec66ea433cb87561fc50b741))
* Change form.object update method ([417a533](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/417a533c23611a2604b5351b7a42400367bd6e90))
* Change private transformValidationErrors to public ([f80e6e9](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/f80e6e908a7487cd06712c65fbe8116d9197dddc))
...
* **deps:** Update dependencies ([5833025](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/5833025bc33f77a77f2fb4d5be4673f707fe689a))
...
* **dynamic-form-builder:** Add ValidatorOptions for nested objects validations ([95b4dfd](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/95b4dfd81cfff1248b5bcecb6a52afafc7cfb77c))
* **dynamic-form-builder:** Divided the old method and the experimental by the optional controlsConfig attr ([928a908](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/928a908b8be18a644c7a555c6b66d9535498b81c))
* **dynamic-form-group:** Change code for correct work with externalErrors (renamed from otherErrors) ([087772b](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/087772b2483091cfaaf0e0d038053d81503110db))
* **dynamic-form-group:** Change return object type for nested object if it type is DynamicFormGroup ([8bb303e](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/8bb303e16da31aa30123ed83ad1612492ea78873))
* **dynamic-form-group:** Fix test error due to recursive types ([87bfee8](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/87bfee87438496853c8e6ae0773b9fc325c8be3a))
* **dynamic-form-group:** Fix validators that expect more than one argument and fix work with conditional validations [#36](https://github.com/EndyKaufman/ngx-dynamic-form-builder/issues/36) ([30a0a6c](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/30a0a6cf70fb92a29fc0b6d437aabafa491cc39a))
* **dynamic-form-group:** Refactor isValid detect in createCustomValidation ([49871c5](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/49871c512dc4caf4ed7bb236a5b067201012998c))
* **dynamic-form-group:** Remove hard dependencies of class-transformer, for use alternative class mapper using the decorators ([8aff1c4](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/8aff1c458d0e8e5f5853be61ce0e89cfbfed3c17))
* Ivalidate formGroup if founded any castomValidationErrors ([26a26ec](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/26a26ecc78eae6738326fdfcb1ec48b01308a7cc))
...
* Revert to original getClassValidators for correct validate arrays and refactor code more readable ([bf296c3](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/bf296c36af0ad28c6d02a4f63b63974709e3433e))
* **scripts:** Update for correct build ([30f53b5](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/30f53b5c86d941f66363254abf9baa3947e56463))
* Set value from control on createNestedValidate if it ([6dc9c1c](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/6dc9c1cc40fb3c9cbaf3fe4cb1419520985ee754))
...
* **sw:** Update path for ngsw-worker.js ([0491271](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/0491271864f0454da3595320e1f7f0809ec15b00))
...
* Update dependencies ([3c88ce1](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/3c88ce1abef6769418e8e679e033577d3bc51bd6))
* Update dependencies ([db8c595](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/db8c595f6dfcb97334d790983b1af2cc4b0d128a))
...
* Update transformValidationErrors for correct output errors for array ([e526426](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/e526426bba378b47b1e21194dffd19355022e7e0))
* Wrong work with exists nested exeperemental sample ([#74](https://github.com/EndyKaufman/ngx-dynamic-form-builder/issues/74)) ([407b9de](https://github.com/EndyKaufman/ngx-dynamic-form-builder/commit/407b9de30890c5d9f72e1bcaa8281a7cd14bb39f))
